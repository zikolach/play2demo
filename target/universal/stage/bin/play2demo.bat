@REM play2demo launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM PLAY2DEMO_config.txt found in the PLAY2DEMO_HOME.
@setlocal enabledelayedexpansion

@echo off

if "%PLAY2DEMO_HOME%"=="" set "PLAY2DEMO_HOME=%~dp0\\.."

set "APP_LIB_DIR=%PLAY2DEMO_HOME%\lib\"
...
set "CFG_FILE=%PLAY2DEMO_HOME%\PLAY2DEMO_config.txt"
set CFG_OPTS=
if exist %CFG_FILE% (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running play2demo.
  echo.
...
"%_JAVACMD%" !_JAVA_OPTS! !PLAY2DEMO_OPTS! -cp "%APP_CLASSPATH%" %MAIN_CLASS% !_APP_ARGS!
